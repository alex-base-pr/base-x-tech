...
| Q-24 | **Done:** /de/pages/complex-solutions/ by our copywriter agent + independent proofread; Alexander or we release. Open: DE link in the language switcher (header shows EN\|UA), "EN" badge on blog cards, "Private App" → "Custom App" in both languages | Alex | page reachable via hreflang/sitemap only | 2026-09-24 |
